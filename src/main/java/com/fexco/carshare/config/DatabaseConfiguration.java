...
@Configuration
@EnableJpaRepositories("com.fexco.carshare.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		factory.setPackagesToScan("com.fexco.carshare.domain");
		return factory;
	}
    

    @Bean(destroyMethod = "shutdown")
    @ConditionalOnMissingClass(name = "com.fexco.carshare.config.HerokuDatabaseConfiguration")
