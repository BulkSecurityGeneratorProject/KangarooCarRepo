...
public class MailConfiguration implements EnvironmentAware {
    ...
    public JavaMailSenderImpl javaMailSender() {
        ...
        String host = "smtp.gmail.com";//propertyResolver.getProperty(PROP_HOST, DEFAULT_PROP_HOST);
        int port = 25;//propertyResolver.getProperty(PROP_PORT, Integer.class, 0);
        String user = "carshareireland@gmail.com";//propertyResolver.getProperty(PROP_USER);
        String password = "$carshare$";//propertyResolver.getProperty(PROP_PASSWORD);
        ...
        sendProperties.setProperty("mail.transport.protocol", "smtp"/*PROP_SMTP_AUTH, auth.toString()*/);
        sendProperties.setProperty("mail.smtp.auth", "true"/*PROP_STARTTLS, tls.toString()*/);
        sendProperties.setProperty("mail.smtp.starttls.enable", "true"/*PROP_TRANSPORT_PROTO, protocol*/);
